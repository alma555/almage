...
public final class Bloomburrow extends ExpansionSet {
    ...
    private Bloomburrow() {
        ...
        cards.add(new SetCardInfo("Camellia, the Seedmiser", 328, Rarity.RARE, mage.cards.c.CamelliaTheSeedmiser.class));
        cards.add(new SetCardInfo("Camellia, the Seedmiser", 346, Rarity.RARE, mage.cards.c.CamelliaTheSeedmiser.class));
