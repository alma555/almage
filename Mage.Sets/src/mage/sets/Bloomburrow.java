...
public final class Bloomburrow extends ExpansionSet {
    ...
    private Bloomburrow() {
        ...
        cards.add(new SetCardInfo("Camellia, The Seedmiser", 207, Rarity.RARE, mage.cards.c.CalamitousTide.class));
        cards.add(new SetCardInfo("Camellia, The Seedmiser", 328, Rarity.RARE, mage.cards.c.CalamitousTide.class));
        cards.add(new SetCardInfo("Camellia, The Seedmiser", 346, Rarity.RARE, mage.cards.c.CalamitousTide.class));
        cards.add(new SetCardInfo("Caretaker's Talent", 6, Rarity.RARE, mage.cards.c.CamelliaTheSeedmiser.class));
